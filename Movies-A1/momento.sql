...
-- drop para tabela e banco, delete para id ou atributos da tabela
...
); -- faz uma cascata, ou seja, só apaga se apagar todos juntos, não permite editar apenas uma informação, mantem inteligados
-- reference e escolhar a outra tabela que deverá ter a primairy key, mas pode usar outra key
